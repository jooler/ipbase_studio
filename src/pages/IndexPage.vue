  ...
  <MainContainer>
    ...
    <template v-if="studioStore.runMode === 'tts'" #headerRight>
      ...
      <q-dialog
        ...
        persistent
        @show="appStore.disableWaveSurferShortcut = true"
    ...
    <template #leftDrawerContent>
      ...
      <q-scroll-area v-else class="fit">
        <StoryBoard
          ...
          :activeItem="studioStore.selectedCard"
...
const restoreCache = async () => {
  ...
  const covertedBlob =
    (await localforage.getItem('covertedBlob')) || (await localforage.getItem('studioAudioBlob'))
