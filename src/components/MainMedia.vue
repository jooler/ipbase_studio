<template>
  <div class="relative-position absolute-full column no-wrap">
    <ArtPlayer v-if="allVideos.length > 0" :src="currentVideo" :autoplay="false" :options="playerOptions"
      ref="artPlayerRef" @ready="onPlayerReady" @play="onPlay" @pause="onPause" @ended="onVideoEnded"
