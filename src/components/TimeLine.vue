<template>
  <div class="column full-height no-wrap">
    ...
    <q-inner-loading v-else-if="isGenerating" :showing="isGenerating">
    ...
    <template v-else>
      ...
      <div class="q-space row q-px-xl gap-sm">
        ...
        <!-- 添加控制面板组件 -->
        <TimelineControls class="q-py-sm" :storyboardCards="studioStore.storyboardCards" :isGenerating="isGenerating"
