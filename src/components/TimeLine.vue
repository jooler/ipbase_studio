...
// 使用TTS和OpenRouter composables (使用storyboard提示词ID和deepseek-r1模型)
const { studioAttrs, jsonContent, textContent: textContentTts } = useTts()
const { generateContentStream, isStreaming, streamContent, streamReasoningContent } = useOpenrouter(
  'storyboard',
