<template>
  <div class="column gap-xs">
    <q-btn color="primary" icon="restart_alt" label="重新生成分镜" :loading="isGenerating" @click="regenerateStoryboard" />
    <q-btn color="secondary" icon="refresh" label="刷新媒体素材" :loading="isLoadingVideos || isLoadingImages"
      @click="refreshMedia" />
